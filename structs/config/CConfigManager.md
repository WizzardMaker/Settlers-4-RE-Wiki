...
class CConfigManager{
    ...
    virtual int             RetrieveSetting(CConfigManager *this, const char *a2, const char *a3, int a4);
    virtual int*            sub_229010(CConfigManager *this, const char *a2, const char *a3, int a4);
    virtual int             sub_229330(CConfigManager *this, int a2, const char *a3, const char *a4, int a5);
